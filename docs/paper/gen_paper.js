...
children.push(P([
  R("The controller expresses its output as a normalized 0–100% "), RI("pressure authority"), R(" command "), RI("u"), R(": 0% is the air valve fully closed — the safe state, in which the vessel self-depressurizes through the membrane — and 100% fully open. The servo driver maps this linearly onto pulse width:"),
]));
...
children.push(P([
  R("When the volumes are entered, the system fits Eq. (2) to the points ("), RI("P̄"), SUB("i"), RI(", Q"), SUB("i"), R(") — where "), RI("P̄"), SUB("i"), R(" is the "), RI("measured mean"), R(" pressure of collection window "), RI("i"), R(", not the nominal setpoint — by ordinary least squares:"),
]));
children.push(EQ([
...
children.push(caption("Table 3. Defense-in-depth pressure ladder."));
