...
children.push(...bullets([
  ...
  "No hardware-only protective layer. The specified mechanical relief valve was not fitted, so every layer of Table 3 depends on the controller running (Section 8). Until it is added, the regulator setting and the manual shut-off at the end of a session are the only bounds that survive a dead controller — and fitting it is the cheapest, highest-value change to this instrument.",
