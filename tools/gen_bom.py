...
ROWS = [
 ...
 ("Sensing & electronics", "Adjustable relief valve CR25-100 (SAFETY)", 1, 18.00, "Amazon", "https://www.amazon.com/Control-Devices-Pressure-Relief-Adjustable/dp/B007GDY3CU", "NOT BEING BOUGHT (Adrian's call) - without it the regulator setting is the only bound on a runaway. Must be ADJUSTABLE if ever ordered: a fixed 5 psi unit cracks below the 35-40 kPa test point"),
