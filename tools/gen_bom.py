...
ROWS = [
 ...
 ("Sensing & electronics", "ADS1115 16-bit I2C ADC", 1, 9.00, "Amazon", "https://www.amazon.com/HiLetgo-Converter-Programmable-Amplifier-Development/dp/B01DLHKMO2", "Power at 3.3V; sensor via 10k/22k divider"),
 ...
 ("Sensing & electronics", "Adjustable relief valve CR25-100 (SAFETY)", 1, 18.00, "Amazon", "https://www.amazon.com/Control-Devices-Pressure-Relief-Adjustable/dp/B007GDY3CU", "ON ORDER again (reinstated for remote operation). ORDERED IS NOT INSTALLED - until it is mounted and set, nothing protects a dead controller. Must be ADJUSTABLE: a fixed 5 psi unit cracks below the 35-40 kPa test point. Set below the vessel limit, above max test point"),
 ...
 ("Fittings — MEASURE tube OD first (Swagelok rig)", "M2.5 standoffs (Pi) + M3/M4 assortment (brackets)", 1, 10.00, "Amazon", "https://www.amazon.com/s?k=M2.5+standoff+screw+assortment+kit", "Pi mounting holes are ~2.7mm = M2.5. M3 does NOT fit the Pi; M4 is for baseplate/servo bracket only"),
